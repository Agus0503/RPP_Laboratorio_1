...
/// \brief Modifico una figurita utilizando los datos recibidos como parametro
///
/// \param unaFigurita variable con la que se lleva a cabo la accion
/// \param selecciones lista de seleccines
/// \param sizeSeleccion tamaño de la lista de selecciones
/// \param clubes lista de clubes
/// \param sizeClubes tamaño de la lista de clubes
/// \param managers lista de managers
/// \param sizeManagers tamaño de la lista de managers
/// \return
